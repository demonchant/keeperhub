...
- Confirm the Karma grant payout address belongs to the intended recipient.
...
- Put the real transaction, KeeperHub execution, Karma milestone, tagged source commit and video links in `SUBMISSION.md`.
